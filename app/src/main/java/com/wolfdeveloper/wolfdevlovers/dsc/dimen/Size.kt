package com.wolfdeveloper.wolfdevlovers.dsc.dimen
...
object Size {
    ...
    val SizeProfile: Dp @Composable get() = dimensionResource(id = R.dimen.size_profile)
    ...
    val Size75: Dp @Composable get() = dimensionResource(id = R.dimen.size_75)
    val Size100: Dp @Composable get() = dimensionResource(id = R.dimen.size_100)
    val Size110: Dp @Composable get() = dimensionResource(id = R.dimen.size_110)
    ...
    val Size370: Dp @Composable get() = dimensionResource(id = R.dimen.size_370)
    val Size400: Dp @Composable get() = dimensionResource(id = R.dimen.size_400)
